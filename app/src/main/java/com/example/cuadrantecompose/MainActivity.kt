    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.text_text_composable),
                backgroundColor = colorResource(R.color.color1),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.title_image_composable),
                description = stringResource(R.string.text_image_composable),
        ...
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.text_row_composable),
                backgroundColor = colorResource(R.color.color3),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.title_column_composable),
                description = stringResource(R.string.text_column_composable),
